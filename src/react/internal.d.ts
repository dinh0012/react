...
export interface Options extends react.Options {
	/** Attach a hook that is invoked before render, mainly to check the arguments. */
	_root?(
		vnode: react.ComponentChild,
...
export interface Component<P = {}, S = {}> extends react.Component<P, S> {
	...
	constructor: react.ComponentType<P>;
...
export interface PreactContext extends react.Context<any> {
	_id: string;
	_defaultValue: any;
}
