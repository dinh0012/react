...
Component.prototype.setState = function (update, callback) {
  ...
  var s = this._nextState !== this.state && this._nextState || (this._nextState = (0, _util.assign)({}, this.state)); // if update() mutates state in-place, skip the copy:

  if (typeof update !== 'function' || (update = update(s, this.props))) {
    (0, _util.assign)(s, update);
...
Component.prototype.forceUpdate = function (callback) {
  ...
  if (parentDom) {
    ...
    var mounts = [];
    dom = (0, _index.diff)(parentDom, vnode, vnode, this._context, parentDom.ownerSVGElement !== undefined, null, mounts, this._ancestorComponent, force, dom);
...
Component.prototype.render = _createElement.Fragment;
/**
 * The render queue
...
function enqueueRender(c) {
  if (!c._dirty && (c._dirty = true) && q.push(c) === 1) {
    (_options["default"].debounceRendering || defer)(process);
  }
}
